...
df_pval <- data.frame(pval_method1=round(runif(10000,0,1),4),
                      noise=rnorm(10000,0,0.1))
df_pval$pval_method2 <- df_pval$pval_method1+df_pval$noise
df_pval$pval_method2 <- ifelse(df_pval$pval_method2>1,1,df_pval$pval_method2)
df_pval$pval_method2 <- ifelse(df_pval$pval_method2<0,0,df_pval$pval_method2)
